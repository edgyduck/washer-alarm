...
int vibration = 0; // vibration marker
...
void loop() {
  ...
  if (count == 0) // no vibration detected
    vibration = 0;
  else
    vibration = 1;
  ...
  int x = ThingSpeak.writeField(myChannelNumber, 1, vibration, myWriteAPIKey);
  if(x == 200){
